...
AI Career Assistant · V0.8

面向求职场景的 AI 简历优化应用
岗位匹配 · RAG 辅助优化 · 事实审核 · 安全版简历 · Evaluation
...
逐项解析 JD，并判断为“已满足 / 部分相关 / 当前未体现”

RAG 辅助优化

检索简历撰写知识，辅助信息排序与措辞优化
...
优化结果先经过独立审核，再生成安全版简历

结构化输出

核心结果使用 JSON，降低自然语言格式变化对前端的影响

模型评测

使用 6 组回归测试持续检查事实一致性、幻觉与信息完整性
